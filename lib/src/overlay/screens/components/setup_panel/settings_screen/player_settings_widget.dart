...
class PlayerSettingsWidget extends StatelessWidget {
            ...
            return Column(
              ...
              children: [
                ListTile(
                  ...
                  trailing: isTouch ? IconButton(onPressed: () => Navigator.of(context).pop(), icon: Icon(Icons.close)) : null,
                      ...
                      child: ListView(
                        ...
                        children: [
                          StringSettingsWidget(
                            ...
                            enterCallback: () async => await controller.savePlayerSettings(
                          ...
                          StringSettingsWidget(
                            ...
                            rightCallback: () async => await controller.savePlayerSettings(
                              playerSettings: playerSettings.copyWith(isAfrEnabled: !playerSettings.isAfrEnabled),
                            ),
                            enterCallback: () async => await controller.savePlayerSettings(
                              playerSettings:
                                  playerSettings.copyWith(isAfrEnabled: defaultPlayerSettings.isAfrEnabled),
                            ),
                            valueTitle: playerSettings.isAfrEnabled == true
                          ...
                          ListTile(
                            ...
                            title: Text(OverlayLocalizations.get('manualFrameRate')),
                            titleTextStyle: Theme.of(context).textTheme.titleLarge,
                            focusColor: AppTheme.focusColor,
                            subtitle: Text(playerSettings.isAfrEnabled == false
                          ...
                          StringSettingsWidget(
                            ...
                            enterCallback: () async => await controller.savePlayerSettings(
                              playerSettings: playerSettings.copyWith(
                                forcedAutoEnable: defaultPlayerSettings.forcedAutoEnable,
                              ),
                            ),
                            valueTitle: playerSettings.forcedAutoEnable == true
                                ? OverlayLocalizations.get('yes')
                                : OverlayLocalizations.get('no'),
                            title: OverlayLocalizations.get('autoEnableSubtitle'),
                          ),
                          ListTile(
                            title: Text(OverlayLocalizations.get('preferredAudioLanguages')),
                            titleTextStyle: Theme.of(context).textTheme.titleLarge,
                            focusColor: AppTheme.focusColor,
                            subtitle: Text((playerSettings.preferredAudioLanguages ?? []).join(', ')),
                            onTap: () {
                              showSideSheet(
                                context: context,
                                bloc: bloc,
                                ...
                                body: MultiLanguageSelector(
                                  ...
                                  onChanged: (List<String> selectedCodes) async {
                                    await controller.savePlayerSettings(
                                      playerSettings: playerSettings.copyWith(preferredAudioLanguages: selectedCodes),
                                    );
                                  },
                                  bloc: bloc,
                                  controller: controller,
                          ...
                          ListTile(
                            title: Text(OverlayLocalizations.get('preferredSubtitleLanguages')),
                            titleTextStyle: Theme.of(context).textTheme.titleLarge,
                            focusColor: AppTheme.focusColor,
                            subtitle: Text((playerSettings.preferredTextLanguages ?? []).join(', ')),
                            onTap: () {
                              showSideSheet(
                                context: context,
                                bloc: bloc,
                                ...
                                body: MultiLanguageSelector(
                                  ...
                                  onChanged: (List<String> selectedCodes) async {
                                    await controller.savePlayerSettings(
                                      playerSettings: playerSettings.copyWith(preferredTextLanguages: selectedCodes),
                                    );
                                  },
                                  controller: controller,
                                  bloc: bloc,
  ...
  Future<void> _setVideoQuality({required PlayerSettings playerSettings, required int action}) async {
    final index = playerSettings.videoQuality.index;
    final videoQuality = VideoQuality.changeValue(index: index, direction: action);
    await controller.savePlayerSettings(playerSettings: playerSettings.copyWith(videoQuality: videoQuality));
  }
}
