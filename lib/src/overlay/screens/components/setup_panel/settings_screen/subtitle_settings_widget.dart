...
class SubtitleSettingsWidget extends StatelessWidget {
  ...
  const SubtitleSettingsWidget({super.key, required this.controller, required this.bloc});
                      ...
                      child: ListView(
                        ...
                        children: [
                          ...
                          StringSettingsWidget(
                            ...
                            rightCallback: () async => await controller.updateSubtitleStyle(
                              subtitleStyle: subtitleStyle.copyWith(
                                applyEmbeddedStyles: !(subtitleStyle.applyEmbeddedStyles ?? true),
                              ),
                            ),
                            ...
                            valueTitle: subtitleStyle.applyEmbeddedStyles == true
                          ...
                          StringSettingsWidget(
                            ...
                            enterCallback: () async => await controller.updateSubtitleStyle(
                              subtitleStyle:
                                  subtitleStyle.copyWith(bottomPadding: defaultSubtitleStyle.bottomPadding),
                            ),
                          ...
                          StringSettingsWidget(
                            ...
                            enterCallback: () async => await controller.updateSubtitleStyle(
                              subtitleStyle:
                                  subtitleStyle.copyWith(rightPadding: defaultSubtitleStyle.rightPadding),
                            ),
                          ...
                          StringSettingsWidget(
                            ...
                            valueTitle:
                                (subtitleStyle.edgeType?.name ?? SubtitleEdgeType.dropShadow.name).toUpperCase(),
                          ...
                          ColorSelectorWidget(
                            ...
                            saveResult: (int itemIndex) async {
                              controller.updateSubtitleStyle(
                                subtitleStyle:
                                    subtitleStyle.copyWith(backgroundColor: ExtendedColors.values[itemIndex]),
                              );
                            },
                            colorList: ExtendedColors.allColors,
                          ),
  ...
  Future<void> _setPadding({required SubtitleStyle subtitleStyle, required int action, required Side side}) async {
    ...
    final newPadding = currentPadding + action > 200
        ? 0
