                ...
                children: [
                  ListTile(
                    ...
                    trailing: isTouch
                        ...
                        : null,
                    title: Text(OverlayLocalizations.get('clock'), textAlign: TextAlign.center),
                    ...
                    child: ListView(
                      ...
                      children: [
                        StringSettingsWidget(
                          ...
                          rightCallback:
                              () async => await _setClockPosition(action: 1, clockSettings: state.clockSettings),
                          enterCallback: () async => await _saveClockSettings(
                            clockSettings:
                                state.clockSettings.copyWith(clockPosition: defaultSettings.clockPosition),
                          ),
                        ...
                        ColorSelectorWidget(
                          ...
                          onTap: () async => await _saveClockSettings(
                          ...
                          saveResult: (int itemIndex) async => await _saveClockSettings(
                            clockSettings:
                                state.clockSettings.copyWith(clockColor: ExtendedColors.values[itemIndex]),
                          ),
                        ...
                        StringSettingsWidget(
                          ...
                          rightCallback: () async => await _saveClockSettings(
                            clockSettings: state.clockSettings.copyWith(
                              showClockBorder: !state.clockSettings.showClockBorder,
                            ),
                          ),
                          ...
                          valueTitle: state.clockSettings.showClockBorder == true
                        ...
                        ColorSelectorWidget(
                          ...
                          saveResult: (int itemIndex) async => await _saveClockSettings(
                            clockSettings:
                                state.clockSettings.copyWith(borderColor: ExtendedColors.values[itemIndex]),
                          ),
                          colorList: ExtendedColors.allColors,
                        ),
                        StringSettingsWidget(
                          ...
                          valueTitle: state.clockSettings.showClockBackground == true
                              ? OverlayLocalizations.get('yes')
                              : OverlayLocalizations.get('no'),
