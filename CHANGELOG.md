...
decoder_mpegh-release.aar). media3 v1.9.0.
...
Flutter UI (e.g., in a list of movies or a focused card).
- Implement dynamic playlist management (add/del item) and automatic pagination
- some UI updates
## 0.0.8
